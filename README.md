...
4. [Delete files in a directory except specified ones](deletefilesexceptfew.sh): This script deletes all files inside a directory except the specified ones.
5. [Delete directories in a directory except specified ones](eletedirectoriesexceptafew.sh): This script deletes all directories inside a directory except the specified ones.
